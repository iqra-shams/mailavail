...
<div className=' md:w-[800] lg:w-[900px]  flex flex-wrap justify-evenly  gap-x-24  '>
{
      data.map((data,i)=>{
        return(
            <div className='w-[300px] h-[292px]  '>
  ...
  <p className='w-[300px] h-[84px] text-[18px] font-medium leading-[28px] text-[#424867]'>{data.description}</p>
</div>
        )
      }
