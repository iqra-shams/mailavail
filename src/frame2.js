...
<div className='bg-[#F5F7FD] md:w-[700px] w-[420px] lg:w-[1180px] h-[1100px]  md:h-[700px] lg:h-[420px] mx-[5%]   my-[3%]  lg:flex justify-center items-center rounded-lg  '>
<div className='w-[450px] h-[380px]  px-5 md:py-8  ml-5 ' >
...
<div className='  w-[380px] md:w-[640px] h-[700px]  md:h-[380px] ml-5 bg-[#FFFFFF] rounded-lg'>
  <div className='py-5'>
